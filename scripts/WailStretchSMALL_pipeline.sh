...
SEGMENTS_DIR="SomaxCorpusWork/Corpora/MultiCorpus4_wail/Segments_wail_augmented_5xStretched"
PROMPT_FILE="scripts/wailStretch_prompts_2.json"
MAX_SEGMENTS="3"  # leave empty for all segments, or set e.g. "5" for quick iteration
SWEEP_N=3  # init_noise_level samples; must match --noise-levels in step 3
...
for ((i=0; i<NUM_PROMPTS; i++)); do
    ...
    OUTDIR="Audio/output/wailStretch300BPMtest/prompt${PROMPT_IDX}_sweep_init_noise_level_${TIMESTAMP}"
