...
,
		"classnamespace" : "box",
		"rect" : [ -266.0, -1348.0, 1985.0, 1314.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 940.000014007091522, 433.600006461143494, 81.0, 22.0 ],
					"text" : "route position"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 923.0, 90.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 859.0, 40.0, 726.0, 22.0 ],
					"text" : "influence chroma 0.460011 0.447582 0.535698 0.553709 0.747614 0.614964 0.514169 0.508551 0.560294 0.438872 0.47768 0.51815"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 961.0, 54.0, 67.0, 22.0 ],
					"text" : "state 119 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1022.0, 97.0, 309.0, 22.0 ],
					"text" : "rawreceive audio event 33468.84375 33659.820312 0 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 961.5, 298.0, 119.0, 22.0 ],
					"text" : "9062. 9257.894531"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 989.0, 134.0, 265.0, 22.0 ],
					"text" : "rawreceive position 33468.84375 33659.820312"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 882.0, 186.0, 183.0, 22.0 ],
					"text" : "position 28595.447266 28766.58"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 984.0, 559.0, 119.0, 35.0 ],
					"text" : "101098.664062 103690.664062"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1038.0, 484.0, 142.0, 22.0 ],
					"text" : "route position rawreceive"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1005.0, 385.0, 32.0, 22.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 925.0, 636.0, 48.0, 76.0 ],
					"text" : "rawreceive playerstatus bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 505.0, 1049.0, 73.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 429.0, 1049.0, 74.0, 22.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 602.0, 1085.0, 84.0, 22.0 ],
					"text" : "p save_preset"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 560.0, 97.0, 276.0, 929.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 514.5, 1078.0, 676.5, 1078.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 611.5, 968.0, 552.35546875, 968.0, 552.35546875, 67.0, 569.5, 67.0 ],
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 438.5, 1078.0, 644.0, 1078.0 ],
					"source" : [ "obj-9", 0 ]
				}
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Documents/Max 9/Packages/OMax4.6/patchers",
				"patcherrelativepath" : "../../../../Documents/Max 9/Packages/OMax4.6/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"bootpath" : "~/Documents/Max 9/Packages/Somax-2.7.0/patchers/resources/influencers",
				"patcherrelativepath" : "../../../../Documents/Max 9/Packages/Somax-2.7.0/patchers/resources/influencers",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "bc.autoname.js",
				"bootpath" : "~/Documents/Max 9/Packages/OMax4.6/javascript",
				"patcherrelativepath" : "../../../../Documents/Max 9/Packages/OMax4.6/javascript",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"bootpath" : "~/Documents/Max 9/Packages/Somax-2.7.0/patchers/resources/misc",
				"patcherrelativepath" : "../../../../Documents/Max 9/Packages/Somax-2.7.0/patchers/resources/misc",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "monitor.png",
				"bootpath" : "~/Documents/Max 9/Packages/Somax-2.7.0/media",
				"patcherrelativepath" : "../../../../Documents/Max 9/Packages/Somax-2.7.0/media",
				"type" : "PNG",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"bootpath" : "~/Documents/Max 9/Packages/Somax-2.7.0/patchers/resources/player",
				"patcherrelativepath" : "../../../../Documents/Max 9/Packages/Somax-2.7.0/patchers/resources/player",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"bootpath" : "~/Documents/Max 9/Packages/Somax-2.7.0/patchers",
				"patcherrelativepath" : "../../../../Documents/Max 9/Packages/Somax-2.7.0/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"bootpath" : "~/Documents/Max 9/Packages/Somax-2.7.0/patchers/resources/server",
				"patcherrelativepath" : "../../../../Documents/Max 9/Packages/Somax-2.7.0/patchers/resources/server",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
